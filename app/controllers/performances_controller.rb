class PerformancesController < ApplicationController
  ...
  def create
    ...
    #Convert the string generated by Any+Time to datetime format 
    @performance.perf_start = DateTime.strptime("#{@performance.perf_startstr}", "%m/%d/%Y at %I:%M %p").to_time
    @performance.perf_end = DateTime.strptime("#{@performance.perf_endstr}", "%m/%d/%Y at %I:%M %p").to_time
